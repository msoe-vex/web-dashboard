...
export function getFieldMousePosVar() {
    return getFieldMousePos;
}
 ...
 */
export function newSharedWaypoint() {
 ...
 */
export function newSharedButton(name) {
 ...
 */
export function loadSharedButtons() {
    sharedWaypoints.forEach(function (point) {
 ...
 */
export function autonCreatorInit() {
    //connectToRobot();
 ...
 */
export function loadWaypointConfig() {
 ...
 */
export function saveWaypointConfig() {
 ...
 */
export function autonCreatorDataLoop() {
 ...
 */
export function autonCreatorDrawLoop() {
 ...
 */
export function pathAsText(pretty) {
    let output = {
...
export function connectedToRobot() {
    if (ws) {
 ...
 */
export function inchesToPixels(pointInInches) {
 ...
 */
export function pixelsToInches(pointInPixels) {
    function px2inY(px) {
        return px / ratio;
    }
